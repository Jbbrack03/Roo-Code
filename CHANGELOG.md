...
- Fix TypeScript and linting errors with WebAssembly instantiate types
- Add proper type handling for Set iteration in provider implementations 
- Improve WebAssembly module loading in LM Studio and other providers
- Fix token counting worker types and configuration
